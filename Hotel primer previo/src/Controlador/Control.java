...
public class Control implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        int eee = Integer.parseInt(h.cedula.getText());
        int aaa = Integer.parseInt(h.telefono.getText());
       ...
       h.rta.setText("se agrego como responsable el señor/a "+h.nombre.getText()+" correctamente en la habitacion "+numero);
        ...
        int hab = Integer.parseInt(numero);
        int eee = Integer.parseInt(h.ee.getText());
        int aaa = Integer.parseInt(h.aa.getText());
      //  int haa = Integer.parseInt(nhabitacion1.getText());
